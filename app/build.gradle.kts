...
dependencies {
    ...
    // android.jar's org.json classes are stubs that throw at runtime in plain JVM unit
    // tests; pull in the real implementation so JSONObject usage in tests actually works.
